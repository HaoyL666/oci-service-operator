...
- Supported in-place updates are limited to `weight`, `maxConnections`,
  `backup`, `drain`, and `offline`, matching `UpdateBackendDetails`. Drift on
  `loadBalancerId`, `backendSetName`, `ipAddress`, or `port` remains
