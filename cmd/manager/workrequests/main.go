...
func init() {
	...
	utilruntime.Must(workrequestsv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "workrequests",
		LeaderElectionID:   "40558063.oci.workrequests",
		SkipFIPS:           true,
	}, managerservices.ForGroup("workrequests")); err != nil {
		os.Exit(1)
	}
}
