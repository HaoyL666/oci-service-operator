...
// OpensearchOpensearchClusterSpec defines the desired state of OpensearchOpensearchCluster.
type OpensearchOpensearchClusterSpec struct {
...
// OpensearchOpensearchClusterStatus defines the observed state of OpensearchOpensearchCluster.
type OpensearchOpensearchClusterStatus struct {
...
// +kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.status.conditions[-1].type",description="status of the OpensearchOpensearchCluster",priority=0
// +kubebuilder:printcolumn:name="Ocid",type="string",JSONPath=".status.status.ocid",description="Ocid of the OpensearchOpensearchCluster",priority=1
// +kubebuilder:printcolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp",priority=0
// OpensearchOpensearchCluster is the Schema for the opensearchopensearchclusters API.
type OpensearchOpensearchCluster struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   OpensearchOpensearchClusterSpec   `json:"spec,omitempty"`
	Status OpensearchOpensearchClusterStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true
// OpensearchOpensearchClusterList contains a list of OpensearchOpensearchCluster.
type OpensearchOpensearchClusterList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OpensearchOpensearchCluster `json:"items"`
}

func init() {
	SchemeBuilder.Register(&OpensearchOpensearchCluster{}, &OpensearchOpensearchClusterList{})
}
