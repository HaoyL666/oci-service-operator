...
var newBucketServiceClient = func(manager *BucketServiceManager) BucketServiceClient {
	...
	config := generatedruntime.Config[*objectstoragev1beta1.Bucket]{
		...
		Create: &generatedruntime.Operation{
			...
			Fields: []generatedruntime.RequestField{{FieldName: "NamespaceName", RequestName: "namespaceName", Contribution: "path", PreferResourceID: false, LookupPaths: []string{"status.namespace", "spec.namespace", "namespaceName", "namespace"}}, {FieldName: "CreateBucketDetails", RequestName: "CreateBucketDetails", Contribution: "body", PreferResourceID: false}},
		},
		Get: &generatedruntime.Operation{
			...
			Fields: []generatedruntime.RequestField{{FieldName: "NamespaceName", RequestName: "namespaceName", Contribution: "path", PreferResourceID: false, LookupPaths: []string{"status.namespace", "spec.namespace", "namespaceName", "namespace"}}, {FieldName: "BucketName", RequestName: "bucketName", Contribution: "path", PreferResourceID: false, LookupPaths: []string{"status.name", "spec.name", "name"}}, {FieldName: "Fields", RequestName: "fields", Contribution: "query", PreferResourceID: false}},
		},
		List: &generatedruntime.Operation{
			...
			Fields: []generatedruntime.RequestField{{FieldName: "NamespaceName", RequestName: "namespaceName", Contribution: "path", PreferResourceID: false, LookupPaths: []string{"status.namespace", "spec.namespace", "namespaceName", "namespace"}}, {FieldName: "CompartmentId", RequestName: "compartmentId", Contribution: "query", PreferResourceID: false}, {FieldName: "Limit", RequestName: "limit", Contribution: "query", PreferResourceID: false}, {FieldName: "Page", RequestName: "page", Contribution: "query", PreferResourceID: false}, {FieldName: "Fields", RequestName: "fields", Contribution: "query", PreferResourceID: false}},
		},
		...
		Delete: &generatedruntime.Operation{
			...
			Fields: []generatedruntime.RequestField{{FieldName: "NamespaceName", RequestName: "namespaceName", Contribution: "path", PreferResourceID: false, LookupPaths: []string{"status.namespace", "spec.namespace", "namespaceName", "namespace"}}, {FieldName: "BucketName", RequestName: "bucketName", Contribution: "path", PreferResourceID: false, LookupPaths: []string{"status.name", "spec.name", "name"}}},
		},
	}
	if err != nil {
