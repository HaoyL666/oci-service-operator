...
func TestMockIntegrationPatternCompositeCRUD(t *testing.T) {
  ...
  "lifecycleState": "ACTIVE"
	...
	responder, err := ocimock.NewExplicitCRUDResponder(ocimock.ExplicitCRUDOptions[datacatalogsdk.Pattern, struct{}, struct{}]{
		...
		ValidateCreateRaw: func(request ocimock.Request) error {
			return validatePatternBodyField(request, "displayName", "pattern create")
		},
		ValidateUpdateRaw: func(request ocimock.Request) error {
			return validatePatternBodyField(request, "description", "updated")
		},
	})
	if err != nil {
		t.Fatal(err)
...
func validatePatternBodyField(request ocimock.Request, field string, want string) error {
