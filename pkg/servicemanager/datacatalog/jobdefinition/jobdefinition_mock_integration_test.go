...
func TestMockIntegrationJobDefinitionCompositeCRUD(t *testing.T) {
  ...
  "lifecycleState": "ACTIVE"
	...
	responder, err := ocimock.NewExplicitCRUDResponder(ocimock.ExplicitCRUDOptions[datacatalogsdk.JobDefinition, struct{}, struct{}]{
		...
		ValidateCreateRaw: func(request ocimock.Request) error {
			return validateJobDefinitionBodyField(request, "displayName", "job definition create")
		},
		ValidateUpdateRaw: func(request ocimock.Request) error {
			return validateJobDefinitionBodyField(request, "description", "updated")
		},
	})
	if err != nil {
		t.Fatal(err)
...
func validateJobDefinitionBodyField(request ocimock.Request, field string, want string) error {
