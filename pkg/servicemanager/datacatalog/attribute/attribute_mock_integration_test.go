...
func TestMockIntegrationAttributeCompositeCRUD(t *testing.T) {
  ...
  "lifecycleState": "ACTIVE"
	...
	responder, err := ocimock.NewExplicitCRUDResponder(ocimock.ExplicitCRUDOptions[datacatalogsdk.Attribute, struct{}, struct{}]{
		...
		ValidateCreateRaw: func(request ocimock.Request) error {
			return validateAttributeBodyField(request, "displayName", "attribute create")
		},
		ValidateUpdateRaw: func(request ocimock.Request) error {
			return validateAttributeBodyField(request, "description", "updated")
		},
	})
	if err != nil {
		t.Fatal(err)
...
func validateAttributeBodyField(request ocimock.Request, field string, want string) error {
