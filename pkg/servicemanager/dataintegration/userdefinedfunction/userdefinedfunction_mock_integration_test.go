...
func TestMockIntegrationUserDefinedFunctionCompositeCRUD(t *testing.T) {
  ...
  "key": "resource-key"
	...
	responder, err := ocimock.NewExplicitCRUDResponder(ocimock.ExplicitCRUDOptions[dataintegrationsdk.UserDefinedFunction, struct{}, struct{}]{
		...
		ValidateCreateRaw: func(request ocimock.Request) error {
			return validateUserDefinedFunctionBodyField(request, "name", "function create")
		},
		ValidateUpdateRaw: func(request ocimock.Request) error {
			return validateUserDefinedFunctionBodyField(request, "description", "updated")
		},
	})
	if err != nil {
		t.Fatal(err)
...
func validateUserDefinedFunctionBodyField(request ocimock.Request, field string, want string) error {
