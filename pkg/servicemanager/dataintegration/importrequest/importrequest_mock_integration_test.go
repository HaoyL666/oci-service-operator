...
func TestMockIntegrationImportRequestCompositeCRUD(t *testing.T) {
  ...
  "status": "TERMINATED"
	...
	responder, err := ocimock.NewExplicitCRUDResponder(ocimock.ExplicitCRUDOptions[dataintegrationsdk.ImportRequest, struct{}, struct{}]{
		...
		ValidateCreateRaw: func(request ocimock.Request) error {
			return validateImportRequestBodyField(request, "bucketName", "mock-bucket")
		},
		ValidateUpdateRaw: func(request ocimock.Request) error {
			return validateImportRequestBodyField(request, "status", "TERMINATING")
		},
	})
	if err != nil {
		t.Fatal(err)
...
func validateImportRequestBodyField(request ocimock.Request, field string, want string) error {
