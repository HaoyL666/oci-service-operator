...
| [`credentials`](../../reference/api/psql/v1beta1/index.md#kind-dbsystem-spec-credentials) | The database system administrator credentials. If omitted, `adminUsername` and `adminPassword` secret references remain available for secret-backed credential input. | `object` | No |
