...
| Field | Description | Type | Required | Default | Enum |
| --- | --- | --- | --- | --- | --- |
| `compartmentId` | The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the work request. | `string` | No | - | - |
...
| `identifier` | An OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) or other unique identifier for the resource. | `string` | No | - | - |
...
| Field | Description | Type | Required | Default | Enum |
| --- | --- | --- | --- | --- | --- |
| `code` | A machine-usable code for the error that occurred. For a list of error codes, see API Errors (https://docs.oracle.com/iaas/Content/API/References/apierrors.htm). | `string` | No | - | - |
