...
| Field | Description | Type | Required | Default | Enum |
| --- | --- | --- | --- | --- | --- |
| `code` | A machine-usable code for the error that occurred. Refer to API Errors (https://docs.oracle.com/iaas/Content/API/References/apierrors.htm) for a list of error codes. | `string` | No | - | - |
...
| `timestamp` | The time the error occurred. An RFC3339 formatted datetime string. | `string` | No | - | - |
